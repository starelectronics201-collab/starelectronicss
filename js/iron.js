document.addEventListener("DOMContentLoaded", () => {
  ...
  const whatsappNumber = "923243287065"; // your WhatsApp number
  ...
  // Enable Book Now button once service is selected
  ...
  bookBtn.addEventListener("click", () => {
    ...
    if (!selected) return alert("Please select a problem or service first.");
